...
public class MainActivity extends FragmentActivity implements ActionBar.TabListener  {
    ...
    // When above code button is clicked, what to do.
    @Override
    ...
    private void openLauncher() {
        Intent openLauncher = new Intent(Intent.ACTION_MAIN);
        openLauncher.addCategory(Intent.CATEGORY_HOME);
